...
xt::xarray<int, xt::layout_type::column_major>
example3_xarray_colmajor(const xt::xarray<int, xt::layout_type::column_major>& m)
{
    return xt::transpose(m) + 2;
}
...
xt::xtensor<int, 2, xt::layout_type::column_major>
example3_xtensor2_colmajor(const xt::xtensor<int, 2, xt::layout_type::column_major>& m)
{
    return xt::transpose(m) + 2;
}

xt::xtensor_fixed<int, xt::xshape<4, 3, 2>>
example3_xfixed3(const xt::xtensor_fixed<int, xt::xshape<2, 3, 4>>& m)
{
    return xt::transpose(m) + 2;
}
...
xt::xtensor_fixed<int, xt::xshape<3, 2>, xt::layout_type::column_major>
example3_xfixed2_colmajor(const xt::xtensor_fixed<int, xt::xshape<2, 3>, xt::layout_type::column_major>& m)
{
    return xt::transpose(m) + 2;
}
...
template <>
std::string typestring<uint8_t>()
{
    return "uint8";
}

template <>
std::string typestring<int8_t>()
{
    return "int8";
}

template <>
std::string typestring<uint16_t>()
{
    return "uint16";
}

template <>
std::string typestring<int16_t>()
{
    return "int16";
}

template <>
std::string typestring<uint32_t>()
{
    return "uint32";
}

template <>
std::string typestring<int32_t>()
{
    return "int32";
}

template <>
std::string typestring<uint64_t>()
{
    return "uint64";
}

template <>
std::string typestring<int64_t>()
{
    return "int64";
}
...
void test_rm(const ndarray<int>& x)
{
    ndarray<int> y = x;
...
PYBIND11_MODULE(xtensor_python_test, m)
{
    ...
    m.def(
        "compare_shapes",
        [](const xt::pyarray<double>& a, const xt::pyarray<double>& b)
        {
    ...
    py::class_<test_native_casters>(m, "test_native_casters")
        .def(py::init<>())
        .def("get_array", &test_native_casters::get_array, py::return_value_policy::reference_internal)  // memory
                                                                                                         // managed
                                                                                                         // by
                                                                                                         // the
                                                                                                         // class
                                                                                                         // instance
        .def("get_strided_view", &test_native_casters::get_strided_view, py::keep_alive<0, 1>())  // keep_alive<0,
                                                                                                  // 1>() =>
                                                                                                  // do not
                                                                                                  // free
                                                                                                  // "self"
                                                                                                  ...
                                                                                                  // returned
                                                                                                  // view
        .def("get_array_adapter", &test_native_casters::get_array_adapter, py::keep_alive<0, 1>())  // keep_alive<0,
                                                                                                    // 1>() =>
                                                                                                    // do not
                                                                                                    // free
                                                                                                    // "self"
                                                                                                    ...
                                                                                                    // returned
                                                                                                    // adapter
        .def("get_tensor_adapter", &test_native_casters::get_tensor_adapter, py::keep_alive<0, 1>())  // keep_alive<0,
                                                                                                      // 1>()
                                                                                                      // => do
                                                                                                      // not
                                                                                                      // free
                                                                                                      ...
                                                                                                      // returned
                                                                                                      // adapter
        .def("get_owning_array_adapter", &test_native_casters::get_owning_array_adapter)  // auto memory
                                                                                          // management as the
                                                                                          // adapter owns its
                                                                                          // memory
        .def(
            "view_keep_alive_member_function",
            [](test_native_casters& self, xt::pyarray<double>& a)  // keep_alive<0, 2>() => do not free second
                                                                   // parameter before the returned view
            {
                return xt::reshape_view(
                    a,
                    {
                        a.size(),
                    }
